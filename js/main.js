    ...
    $(document).ready(function() {
        ...
        if ($('#player-radar-graph').length > 0) {
            ...
            $('#player-radar-graph').teamRadarGraph(
                'stats', ["GP", "GS", "FG", "PM", "PT", "FT", "OR", "TO"], [12, 19, 3, 17, 28, 24, 11],
                200,
                200
            );
        ...
        if ($('#label_placement').length > 0) {
            $('#label_placement').label_placement(
                ['2011', '2012', '2013', '2014', '2015', '2016', '2017'], [120, 160, 145, 200, 180, 185, 190],
                true
        ...
        if ($('#animatedonut').length > 0) {
            $('#animatedonut').animatedonut(
                ['1', '2', '3', '4', '5', '6', '7'], [10, 20, 50, 20, 5, 50, 15],
                true,
                true
        ...
        if ($('#horizontalbar').length > 0) {
            $('#horizontalbar').horizontalbar(
                ...
                10,
                true,
                true, ['1-st Component', '2-nd Component'],
                true,
                'bottom',
                70
            );
        ...
        if ($('#gaugechart').length > 0) {
            $('#gaugechart').gaugechart(
                ...
                270,
                200,
                true, ['Investor Name 1', 'Investor Name 2', 'Investor Name 3', 'Investor Name 4'],
                true
            );
        }
...
function countDown() {
    ...
    var timeB = new Date("December 2,2020 23:59:59"); // วันเวลาสิ้นสุด รูปแบบ เดือน/วัน/ปี ชั่วโมง:นาที:วินาที
    ...
    if (timeDifference >= 0) {
        ...
        // document.getElementById('day').innerHTML = wan + '&emsp;  :  &emsp;' + hour + '&emsp;  :  &emsp;' + minute + '&emsp;  :  &emsp;' + second;
        document.getElementById('js-days').innerHTML = wan;
        document.getElementById('js-hours').innerHTML = hour;
        ...
        $.ajax({
            ...
            success: function(data) {
                if (data == 2) {
                    ...
                    swal("WELCOME TO WD FIFA ONLINE 4!", "Success you can start to create Team. !", "success");
        ...
        $.ajax({
            ...
            success: function(data) {
                if (data == 1) {
                    ...
                    swal("Error!", "Email or password not match. !", "error");
